...
if(len(sys.argv) != 4):
    print('run as: "python VideoAnalyzerTrackNetLS.py <video_da_analizzare> <file_csv_TrackNet_con_colpi_LS> <file_csv_TrackNet_base_senza_colpi>')
    exit(1)
...
arguments = [video, './FINAL_DATA/fileTrackNet/tracknet_norm_with_shots_predict.csv', './FINAL_DATA/video/perf/tracknet/video_tennis_predict_perfect_6.mp4']
