...
if(len(sys.argv) != 4):
    print('run as: "python VideoAnalyzerMoveNet.py <video_da_analizzare> <file_csv_TrackNet_con_colpi_Cioni> <file_csv_MoveNet_base>')
    exit(1)
...
# Vengono prese tutte le righe e tutte le colonne a eccezione della prima e l'ultima ('Shot') quindi abbiamo una matrice n x m-2
# X sono i campioni!
...
arguments = [video, './FINAL_DATA/fileMoveNet/movenet_norm_with_shots_predict.csv', './FINAL_DATA/video/non_perf/movenet/video_tennis_predict_11.mp4']
